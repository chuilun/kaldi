...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "on each arc in the lattice.  Useful for ctc discriminative training, e.g.\n"
        "boosted MMI.  Modifies input lattices.  This version takes the reference\n"
        "in the form of alignments. Takes the --silence-phones option and these\n"
        ...
        "\n"
        "Usage: lattice-boost-ali-ctc [options] lats-rspecifier ali-rspecifier lats-wspecifier\n"
        " e.g.: lattice-boost-ali-ctc --silence-phones=1:2:3 --b=0.05 ark:1.lats ark:1.ali ark:boosted.lats\n";
